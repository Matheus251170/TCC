    ...
    require '../Model/conexao.php';
               ...
               //  $insert_query->bindParam(':escolaridade', $escolaridade);
                ...
                if($insert_query->execute()){
                  ...
                  $_SESSION['msg'] = "<div class='alert alert-primary' role='alert'>Dados atualizados!</div>";  
                  header("Location: TelaPerfil.php");
                }
                else{
                   $_SESSION['erro'] = "<div class='alert alert-danger' role='alert'>Ocorreu um erro! Tente novamente!</div>"; 
